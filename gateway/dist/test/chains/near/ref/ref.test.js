...
jest.useFakeTimers();
const ref_1 = require("../../../../src/connectors/ref/ref");
...
const RefSDK = __importStar(require("coinalpha-ref-sdk"));
let near;
let ref;
const DAI = {
    spec: 'ft-1.0.0',
...
beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield near.init();
    ref = ref_1.Ref.getInstance('near', 'testnet');
    yield ref.init();
}));
afterEach(() => {
    (0, patch_1.unpatch)();
...
const patchInstantSwap = () => {
    (0, patch_1.patch)(RefSDK, 'instantSwap', () => {
        return [];
    });
};
const patchSignHelper = () => {
    (0, patch_1.patch)(ref_1.Ref, 'getSignedTransactions', () => {
        return [];
    });
};
const patchSendHelper = (result) => {
    (0, patch_1.patch)(ref_1.Ref, 'sendTransactions', () => {
        return result;
    });
};
const patchFetcher = () => {
    (0, patch_1.patch)(RefSDK, 'fetchAllPools', () => {
        return {
            simplePools: [],
            unRatedPools: [],
            ratedPools: [],
...
const patchEstimateSwap = () => {
    (0, patch_1.patch)(RefSDK, 'estimateSwap', () => {
        return [
            {
                ...
                pool: {
                    ...
                    gamma_bps: [],
                    id: 1207,
                    partialAmountIn: '0.988562670855139614',
                    supplies: [Object],
                    token0_ref_price: '0',
                    tokenIds: [Array],
                    Dex: undefined,
                ...
                routeOutputToken: '6b175474e89094c44da98b954eedeac495271d0f.factory.bridge.near',
...
const patchEstimateSwapWithError = () => {
    (0, patch_1.patch)(RefSDK, 'estimateSwap', () => {
        return [];
    });
};
describe('verify Ref estimateSellTrade', () => {
    it('Should return an ExpectedTrade when available', () => __awaiter(void 0, void 0, void 0, function* () {
        patchFetcher();
        patchEstimateSwap();
        const expectedTrade = yield ref.estimateSellTrade(ETH, DAI, '1');
        expect(expectedTrade).toHaveProperty('trade');
        expect(expectedTrade).toHaveProperty('expectedAmount');
    }));
    it('Should throw an error if no pair is available', () => __awaiter(void 0, void 0, void 0, function* () {
        patchFetcher();
        patchEstimateSwapWithError();
        yield expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield ref.estimateSellTrade(ETH, DAI, '1');
        })).rejects.toThrow(error_handler_1.UniswapishPriceError);
    }));
});
describe('verify Ref estimateBuyTrade', () => {
    it('Should return an ExpectedTrade when available', () => __awaiter(void 0, void 0, void 0, function* () {
        patchFetcher();
        patchEstimateSwap();
        const expectedTrade = yield ref.estimateBuyTrade(ETH, DAI, '1');
        expect(expectedTrade).toHaveProperty('trade');
        expect(expectedTrade).toHaveProperty('expectedAmount');
    }));
    it('Should return an error if no pair is available', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patchEstimateSwapWithError();
        yield expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield ref.estimateBuyTrade(ETH, DAI, '1');
        })).rejects.toThrow(error_handler_1.UniswapishPriceError);
    }));
});
describe('getAllowedSlippage', () => {
    it('return value of string when not null', () => {
        const allowedSlippage = ref.getAllowedSlippage('3/100');
        expect(allowedSlippage).toEqual(0.03);
    });
    it('return value from config when string is null', () => {
        const allowedSlippage = ref.getAllowedSlippage();
...
describe('verify Ref executeTrade', () => {
    it('Should return an error if no pair is available', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patchSendHelper([]);
        yield expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield ref.executeTrade(yield near.getWalletFromPrivateKey('ed25519:2wyRcSwSuHtRVmkMCGjPwnzZmQLeXLzLLyED1NDMt4BjnKgQL6tF85yBx6Jr26D2dUNeC716RBoTxntVHsegogYw', 'test'), [], '0.1', ETH, DAI);
        })).rejects.toThrow();
    }));
});
