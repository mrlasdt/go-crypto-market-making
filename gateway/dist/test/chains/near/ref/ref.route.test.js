...
const patchStoredTokenList = () => {
    (0, patch_1.patch)(near, 'tokenList', () => {
        return [
            {
                chainId: 0,
                decimals: 18,
...
const patchGetTokenByAddress = () => {
    (0, patch_1.patch)(ref, 'getTokenByAddress', () => {
        return {
            chainId: 0,
            spec: 'ft-1.0.0',
            name: 'Dai Stablecoin',
...
const patchGasPrice = () => {
    (0, patch_1.patch)(near, 'gasPrice', () => 100);
};
const patchEstimateBuyTrade = () => {
    (0, patch_1.patch)(ref, 'estimateBuyTrade', () => {
        return {
            expectedAmount: '100',
            trade: tradePath,
        };
...
const patchEstimateSellTrade = () => {
    (0, patch_1.patch)(ref, 'estimateSellTrade', () => {
        return {
            expectedAmount: '100',
            trade: tradePath,
        };
...
const patchExecuteTrade = () => {
    (0, patch_1.patch)(ref, 'executeTrade', () => {
...
describe('POST /amm/trade', () => {
    ...
    it('should return 500 for SELL with price lower than limitPrice', () => __awaiter(void 0, void 0, void 0, function* () {
        patchForSell();
        yield (0, supertest_1.default)(app_1.gatewayApp)
            .post(`/amm/trade`)
            .send({
    ...
    it('should return 500 for BUY with price higher than limitPrice', () => __awaiter(void 0, void 0, void 0, function* () {
        patchForBuy();
        yield (0, supertest_1.default)(app_1.gatewayApp)
            .post(`/amm/trade`)
            .send({
...
describe('POST /amm/estimateGas', () => {
    it('should return 200 for valid connector', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(app_1.gatewayApp)
            ...
            expect(res.body.gasCost).toEqual(String((100 * ref.gasLimitEstimate) / 1e24));
        });
    }));
});
//# sourceMappingURL=ref.route.test.js.map