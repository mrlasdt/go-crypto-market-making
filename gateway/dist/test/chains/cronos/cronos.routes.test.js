...
const patchGetNonce = () => {
    (0, patch_1.patch)(cronos.nonceManager, 'getNonce', () => 0);
};
const patchGetTokenBySymbol = () => {
    (0, patch_1.patch)(cronos, 'getTokenBySymbol', () => {
        return {
            chainId: 25,
...
const patchApproveERC20 = () => {
    (0, patch_1.patch)(cronos, 'approveERC20', () => {
        return {
            type: 2,
            chainId: 25,
            nonce: 0,
...
const patchGetERC20Allowance = () => {
    (0, patch_1.patch)(cronos, 'getERC20Allowance', () => ({ value: 1, decimals: 3 }));
};
const patchGetNativeBalance = () => {
    (0, patch_1.patch)(cronos, 'getNativeBalance', () => ({ value: 1, decimals: 3 }));
};
const patchGetERC20Balance = () => {
    (0, patch_1.patch)(cronos, 'getERC20Balance', () => ({ value: 1, decimals: 3 }));
};
...
describe('POST /network/poll', () => {
    ...
    it('should get an OUT of GAS error for failed out of gas transactions', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, patch_1.patch)(cronos, 'getCurrentBlockNumber', () => 1);
        (0, patch_1.patch)(cronos, 'getTransaction', () => transactionOutOfGas);
        (0, patch_1.patch)(cronos, 'getTransactionReceipt', () => transactionOutOfGasReceipt);
        const res = yield (0, supertest_1.default)(app_1.gatewayApp).post('/network/poll').send({
            chain: 'cronos',
            network: 'testnet',
            txHash: '0xffdb7b393b46d3795b82c94b8d836ad6b3087a914244634fa89c3abbbf00ed72',
    ...
    it('should get a null in txReceipt for Tx in the mempool', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, patch_1.patch)(cronos, 'getCurrentBlockNumber', () => 1);
        (0, patch_1.patch)(cronos, 'getTransaction', () => transactionOutOfGas);
        (0, patch_1.patch)(cronos, 'getTransactionReceipt', () => null);
        const res = yield (0, supertest_1.default)(app_1.gatewayApp).post('/network/poll').send({
            chain: 'cronos',
            network: 'testnet',
            txHash: '0xffdb7b393b46d3795b82c94b8d836ad6b3087a914244634fa89c3abbbf00ed72',
    ...
    it('should get a null in txReceipt and txData for Tx that didnt reach the mempool and TxReceipt is null', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, patch_1.patch)(cronos, 'getCurrentBlockNumber', () => 1);
        (0, patch_1.patch)(cronos, 'getTransaction', () => null);
        (0, patch_1.patch)(cronos, 'getTransactionReceipt', () => null);
        const res = yield (0, supertest_1.default)(app_1.gatewayApp).post('/network/poll').send({
            chain: 'cronos',
            network: 'testnet',
    ...
    it('should get txStatus = 1 for a succesful query', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, patch_1.patch)(cronos, 'getCurrentBlockNumber', () => 1);
        (0, patch_1.patch)(cronos, 'getTransaction', () => transactionSuccesful);
        (0, patch_1.patch)(cronos, 'getTransactionReceipt', () => transactionSuccesfulReceipt);
        const res = yield (0, supertest_1.default)(app_1.gatewayApp).post('/network/poll').send({
            chain: 'cronos',
            network: 'testnet',
            txHash: '0xffdb7b393b46d3795b82c94b8d836ad6b3087a914244634fa89c3abbbf00ed72',
...
//# sourceMappingURL=cronos.routes.test.js.map