...
const patchGetTokenByAddress = () => {
    (0, patch_1.patch)(madMeerkat, 'getTokenByAddress', () => {
        return {
            chainId: 43114,
            name: 'WETH',
            symbol: 'WETH',
...
const patchEstimateBuyTrade = () => {
    (0, patch_1.patch)(madMeerkat, 'estimateBuyTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchEstimateSellTrade = () => {
    (0, patch_1.patch)(madMeerkat, 'estimateSellTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchExecuteTrade = () => {
    (0, patch_1.patch)(madMeerkat, 'executeTrade', () => {
...
//# sourceMappingURL=mad-meerkat.routes.test.js.map