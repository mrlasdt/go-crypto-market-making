...
const patchGetTokenByAddress = () => {
    (0, patch_1.patch)(pangolin, 'getTokenByAddress', () => {
        return {
            chainId: 43114,
            name: 'WETH',
            symbol: 'WETH',
...
const patchEstimateBuyTrade = () => {
    (0, patch_1.patch)(pangolin, 'estimateBuyTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchEstimateSellTrade = () => {
    (0, patch_1.patch)(pangolin, 'estimateSellTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchExecuteTrade = () => {
    (0, patch_1.patch)(pangolin, 'executeTrade', () => {
...
//# sourceMappingURL=pangolin.routes.test.js.map