...
jest.useFakeTimers();
const pangolin_1 = require("../../../../src/connectors/pangolin/pangolin");
...
beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    pangolin = pangolin_1.Pangolin.getInstance('avalanche', 'fuji');
    yield pangolin.init();
}));
beforeEach(() => {
    (0, evm_nonce_mock_1.patchEVMNonceManager)(avalanche.nonceManager);
...
describe('verify Pangolin estimateSellTrade', () => {
    it('Should return an ExpectedTrade when available', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const expectedTrade = yield pangolin.estimateSellTrade(WETH, WAVAX, ethers_1.BigNumber.from(1));
    ...
    it('Should throw an error if no pair is available', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield pangolin.estimateSellTrade(WETH, WAVAX, ethers_1.BigNumber.from(1));
...
describe('verify Pangolin estimateBuyTrade', () => {
    it('Should return an ExpectedTrade when available', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const expectedTrade = yield pangolin.estimateBuyTrade(WETH, WAVAX, ethers_1.BigNumber.from(1));
        expect(expectedTrade).toHaveProperty('trade');
        expect(expectedTrade).toHaveProperty('expectedAmount');
    }));
    it('Should return an error if no pair is available', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield pangolin.estimateBuyTrade(WETH, WAVAX, ethers_1.BigNumber.from(1));
        })).rejects.toThrow(error_handler_1.UniswapishPriceError);
    }));
});
...
//# sourceMappingURL=pangolin.test.js.map