...
const patchInit = () => {
    (0, patch_1.patch)(defira, 'init', () => __awaiter(void 0, void 0, void 0, function* () {
        return;
    }));
};
...
const patchGetTokenByAddress = () => {
    (0, patch_1.patch)(defira, 'getTokenByAddress', () => {
        return {
            chainId: 1666700000,
            name: 'WONE74',
            symbol: 'WONE74',
...
const patchEstimateBuyTrade = () => {
    (0, patch_1.patch)(defira, 'estimateBuyTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchEstimateSellTrade = () => {
    (0, patch_1.patch)(defira, 'estimateSellTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchExecuteTrade = () => {
    (0, patch_1.patch)(defira, 'executeTrade', () => {
...
describe('POST /amm/price', () => {
    ...
    it('should return 500 when the priceSwapIn operation fails', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patchGetTokenBySymbol();
        patchGetTokenByAddress();
        (0, patch_1.patch)(defira, 'priceSwapIn', () => {
            return 'error';
        });
        yield (0, supertest_1.default)(app)
            .post(`/amm/price`)
    ...
    it('should return 500 when the priceSwapOut operation fails', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patchGetTokenBySymbol();
        patchGetTokenByAddress();
        (0, patch_1.patch)(defira, 'priceSwapOut', () => {
            return 'error';
        });
        yield (0, supertest_1.default)(app)
            .post(`/amm/price`)
...
describe('POST /amm/estimateGas', () => {
    it('should return 200 for valid connector', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(app)
            ...
            expect(res.body.gasCost).toEqual((0, base_1.gasCostInEthString)(100, defira.gasLimitEstimate));
        });
    }));
...
//# sourceMappingURL=defira.routes.test.js.map