...
const config_1 = __importDefault(require("./fixtures/config"));
const helpers_1 = require("./fixtures/helpers");
const patches_1 = __importStar(require("./fixtures/patches/patches"));
...
it('getOrders [4, 5]', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield expect(() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, serum_controllers_1.getOrders)(solana, serum, request);
