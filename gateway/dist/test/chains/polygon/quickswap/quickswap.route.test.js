...
const patchGetWallet = () => {
    (0, patch_1.patch)(polygon, 'getWallet', () => {
        return {
...
const patchStoredTokenList = () => {
    (0, patch_1.patch)(polygon, 'tokenList', () => {
        return [
            {
                chainId: 43114,
                name: 'WETH',
...
const patchGetTokenBySymbol = () => {
    (0, patch_1.patch)(polygon, 'getTokenBySymbol', (symbol) => {
        if (symbol === 'WETH') {
            return {
                chainId: 43114,
                name: 'WETH',
...
const patchGetTokenByAddress = () => {
    (0, patch_1.patch)(quickswap, 'getTokenByAddress', () => {
        return {
            chainId: 43114,
            name: 'WETH',
            symbol: 'WETH',
...
const patchGasPrice = () => {
    (0, patch_1.patch)(polygon, 'gasPrice', () => 100);
};
const patchEstimateBuyTrade = () => {
    (0, patch_1.patch)(quickswap, 'estimateBuyTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchEstimateSellTrade = () => {
    (0, patch_1.patch)(quickswap, 'estimateSellTrade', () => {
        return {
            expectedAmount: {
                toSignificant: () => 100,
            },
...
const patchGetNonce = () => {
    (0, patch_1.patch)(polygon.nonceManager, 'getNonce', () => 21);
};
const patchExecuteTrade = () => {
    (0, patch_1.patch)(quickswap, 'executeTrade', () => {
...
//# sourceMappingURL=quickswap.route.test.js.map